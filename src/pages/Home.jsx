...
<div className="absolute inset-0 -z-10 overflow-hidden">
  ...
  {/* HERO CONTENT */}
 <div className="relative z-20 max-w-7xl mx-auto grid lg:grid-cols-3 gap-10 items-center 2xl:max-w-none 2xl:px-32 ">


    {/* LEFT TEXT */}
    <div className="space-y-5">
      <p className="text-[#0E6388] font-semibold tracking-wide xl:text-2xl">
        → Digital Growth Agency
      </p>

      <h1 className="text-4xl md:text-5xl font-extrabold text-[#063349] leading-tight 2xl:text-6xl">
        We Design Marketing Experiences  That
{" "} 
        <span className="text-4xl md:text-5xl text-transparent bg-clip-text bg-gradient-to-r from-[#0E6388] to-[#1E8FB9] 2xl:text-6xl">
          Turn  Attention Into Long-Term Brand Value.
        </span>
      </h1>

      <p className="text-[#063349]/80 text-lg max-w-md xl:text-2xl xl:max-w-4xl">
      ...
      <div className="flex gap-4">
        <Link to="/contact">
          <button className="px-8 py-3 rounded-full text-white font-semibold bg-gradient-to-r from-[#0E6388] to-[#1283B1] shadow-lg hover:opacity-90 transition 2xl:text-3xl">
            Start a Project →
          </button>
        </Link>

        <Link to="/work-gallery">
          <button className="px-8 py-3 rounded-full border border-[#0E6388] text-[#0E6388] font-semibold hover:bg-[#eaf6ff] shadow-sm transition 2xl:text-3xl">
            View Work
          </button>
        </Link>
      </div>
  ...
  {[
    ...
    >
      ...
      <div
        ...
        "
      >
        <span className="text-3xl sm:text-4xl lg:text-5xl 2xl:text-6xl">
          <CounterHero target={stat.value} />
        </span>
        <span className="text-base sm:text-lg lg:text-xl 2xl:text-2xl">
          {stat.suffix}
        </span>
      </div>
      ...
      <div className="basis-[50%] sm:basis-[55%] lg:basis-[55%]">
        <p className="text-[#063349] font-semibold text-sm sm:text-base 2xl:text-xl">
          {stat.label}
        </p>
      </div>
    </div>
...
<div className="w-full overflow-hidden leading-none -mb-[1px] ">
  ...
  >
    <path
      fill="#1175a0"
      d="M0,80 C240,140 480,0 720,60 C960,120 1200,20 1440,80 L1440,170 L0,170 Z"
    />
  </svg>
</div>
<section className="relative pb-16 overflow-hidden" style={{ background: "#1175a0" }}>
  <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-6 xl:px-4 2xl:max-w-none 2xl:px-32">
  ...
  <div className="mx-auto text-center relative z-20">
    <p className="text-white font-semibold tracking-wide mb-2 xl:text-2xl">
      → Our Work
    </p>

    <h2 className="text-3xl md:text-5xl font-extrabold text-[#063349] leading-[1.3] 2xl:text-6xl">
      Our Work in <span className="text-white">Action</span>
    </h2>

    <p className="text-white text-lg md:text-xl xl:text-2xl mx-auto mt-4 leading-relaxed">
      Explore real campaigns across SMM, Branding, Influencer Marketing & more.
    </p>

    {/* SERVICE FILTERS */}
    <div className="hidden md:flex justify-center gap-4 md:gap-6 mt-12 mb-12 flex-wrap 2xl:text-3xl">
      {services.map((srv) => (
        <button
          key={srv}
          onClick={() => {
...
<div className="md:hidden flex items-center justify-center gap-4 mt-10 mb-8">
  ...
  <div
    className={`
      mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 transition-all duration-500 relative z-20
      ${
        isAnimating
          ? direction === "left"
...
<section ref={servicesSectionRef} className="py-18 md:py-24 px-6">
  <div className="max-w-7xl mx-auto text-center 2xl:max-w-none 2xl:px-32">
    <p className="text-[#0E6388] font-semibold tracking-wide mb-2 xl:text-2xl">
      → Our Services
    </p>

    <h2 className="text-3xl md:text-5xl font-extrabold text-[#063349] 2xl:text-6xl
    ">
      What We Bring
      <span className="text-[#0E6388]"> to the Table</span>
    </h2>

    <p className="text-[#063349]/80 text-lg mx-auto mt-4 xl:text-2xl">
    ...
    >
      {[
        ...
        >
          ...
          <h3 className="text-xl font-extrabold mb-3 text-center 2xl:text-4xl">
            {service.title}
          </h3>

          <p className="text-white/85 text-sm text-center 2xl:text-2xl">
            {service.desc}
          </p>

          <ul className="text-white/80 text-sm mt-4 space-y-1 text-left mx-auto w-[85%] 2xl:text-xl">
          ...
          <a
            href="/contact"
            className="mt-6 w-full py-3 rounded-full text-center font-semibold bg-white text-[#063349] 2xl:text-3xl"
          >
            Start Project →
          </a>
        </div>
...
<section className="relative py-20 pb-12 px-6 bg-[#1175a0] overflow-hidden">
  <div className="max-w-7xl mx-auto text-center text-white relative z-10 2xl:max-w-none 2xl:px-32">
    
    <p className="font-semibold tracking-wide mb-2 opacity-90 xl:text-2xl">
      → Performance Stats
    </p>
    ...
    <p className="text-white/80 text-lg  mx-auto mt-4 xl:text-2xl">
    ...
    <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-16">
      {stats.map((stat, i) => (
        <div
          ...
          "
        >
          <h3 className="text-4xl font-extrabold 2xl:text-6xl">
            <SmartCounter value={stat.value} />
          </h3>

          <p className="text-lg mt-1 font-semibold 2xl:text-2xl">{stat.label}</p>

          <p className="text-white/70 text-sm mt-3 leading-relaxed 2xl:text-2xl">
            {stat.desc}
          </p>
        </div>
      ))}
...
<section className="hidden sm:block relative overflow-hidden py-20 px-6">
  ...
  <div className="max-w-7xl mx-auto relative z-10 2xl:max-w-none 2xl:px-32">
    ...
    <div className="text-center mb-20">
      ...
      <h2 className="text-4xl md:text-5xl font-extrabold text-[#063349] 2xl:text-6xl">
        How We <span className="text-[#0E6388]">Work</span>
      </h2>

      <p className="text-[#063349]/70 mt-4  mx-auto text-lg xl:text-2xl">
    ...
    {[
      ...
      >
        ...
        >
          <span className="inline-block bg-[#0E6388] text-white px-4 py-1.5 rounded-full font-bold mb-4 2xl:text-2xl">
            Step {item.step}
          </span>

          <h3 className="text-3xl font-extrabold text-[#0E6388] mb-4 2xl:text-4xl">
            {item.title}
          </h3>

          <ul className="space-y-3 text-[#063349]/85 text-base 2xl:text-2xl">
            {item.points.map((p, idx) => (
              <li key={idx}>• {p}</li>
            ))}
          </ul>
...
>
  {[
    ...
    <div
      ...
      "
    >
      <h3 className="text-xl font-bold text-[#063349] mb-3 2xl:text-4xl">
        {card.title}
      </h3>

      <p className="text-[#063349]/80 text-sm leading-relaxed 2xl:text-2xl">
        {card.desc}
      </p>
    </div>
  ))}
        ...
        <section className="py-8 md:py-20 px-6">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-14 2xl:max-w-none 2xl:px-32">
            {/* LEFT TITLE */}
            <div className="flex flex-col justify-center">
              <p className="text-[#0E6388] font-semibold tracking-wide mb-3 xl:text-2xl">
                → FAQ's
              </p>
            ...
            <div className="space-y-5">
              {[
                ...
                >
                  <summary className="text-lg font-semibold text-[#063349] 2xl:text-2xl">
                    {faq.q}
                  </summary>

                  <p className="mt-3 text-sm text-[#063349]/80 leading-relaxed 2xl:text-2xl">
                    {faq.a}
                  </p>
                </details>
              ))}
...
<section className="relative pb-20 px-6 bg-[#1175a0] overflow-hidden -mt-[2px]">
  ...
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-start relative z-10 text-white 2xl:max-w-none 2xl:px-32">
    ...
    >
      <p className="text-white font-semibold tracking-wide xl:text-2xl">→ Contact Us</p>

      <h2 className="text-4xl md:text-5xl font-extrabold leading-tight text-[#063349] 2xl:text-6xl">
        Let’s Build Something <br />
        <span className="text-white/90">Powerful Together</span>
      </h2>

      <p className="text-white/90 text-lg max-w-md xl:text-2xl">
      ...
      <div className="space-y-6 text-left ">
                  ...
                  <a href="mailto:sales@bluenosemarketing.com" className="flex items-center gap-4">
                    ...
                    <span className="text-sm text-white/90 xl:text-xl">sales@bluenosemarketing.com</span>
                  </a>

                  {/* PHONE */}
                  <a href="tel:+19027189007" className="flex items-center gap-4">
                    <Phone className="w-6 h-6 text-white" />
                    <span className="text-sm text-white/90 xl:text-xl">+1 902-718-9007</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-sm text-white/90 xl:text-xl">19 Alma Crescent, Halifax, Canada</span>
                  </a>
                </div>
