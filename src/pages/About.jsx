  ...
  <div className="absolute top-14 left-0 flex w-max animate-brandSlide ">
    {[...Array(2)].map((_, groupIndex) => (
      <div key={groupIndex} className="flex gap-24">
        ...
        {/* EYEBROW */}
        <p className="text-[#0E6388] font-semibold tracking-wide mb-2 text-center 2xl:text-2xl">
          → About Us
        </p>
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="show"
          className="text-3xl md:text-5xl font-extrabold text-[#063349] text-center leading-snug 2xl:text-6xl"
        >
          Grow Brands with 
        ...
        <motion.p
          ...
          initial="hidden"
          animate="show"
          className=" mx-auto mt-4 text-lg md:text-xl text-[#063349]/80 text-center 2xl:text-2xl"
        >
        ...
        {/* STATS GRID */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 max-w-6xl mx-auto mt-14 2xl:max-w-none 2xl:px-32 ">
          {[
            ...
            >
              <div className="text-4xl font-extrabold 2xl:text-5xl">{s.value}</div>
              <div className="text-white/90 mt-2 2xl:text-3xl">{s.label}</div>
            </div>
          ))}
        </div>
        ...
        <section className="mt-20">
          <div className="rounded-3xl p-10 md:p-14 bg-white shadow-xl grid md:grid-cols-2 gap-10 md:gap-16 items-center max-w-7xl mx-auto 2xl:max-w-none 2xl:px-32">

            {/* LEFT TEXT */}
            <div>
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#063349] mb-6 2xl:text-5xl">
               Why Choose         <span className="text-[#0E6388]"> Bluenose? </span> 

              </h2>

              <p className="text-[#063349]/85 leading-relaxed mb-4 2xl:text-2xl">
              ...
              <p className="text-[#063349]/75 leading-relaxed mb-4 2xl:text-2xl">
              ...
              <p className="text-[#063349]/75 leading-relaxed 2xl:text-2xl">
...
<div className="grid grid-cols-2 sm:grid-cols-4 gap-x-12 gap-y-6 mt-8">
  {[
    ...
    <div key={i} className="text-center px-4">
      <div className="text-2xl font-extrabold text-[#0E6388] 2xl:text-4xl">
        {stat.v}
      </div>
      <div className="text-[#0E6388] text-sm mt-1 2xl:text-xl">
        {stat.t}
      </div>
    </div>
  ))}
...
<section className="relative mt-16 mb-10 px-0">
  <div className="relative max-w-7xl mx-auto rounded-3xl overflow-hidden bg-[#1175a0] py-12 px-4 md:px-12 2xl:max-w-none 2xl:px-32">
    ...
    <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-14 items-center rounded-3xl">
      ...
      <div className="w-full bg-white/10 backdrop-blur-xl border border-white/20 p-8 md:p-10 rounded-3xl shadow-xl text-white">
        <h2 className="text-3xl md:text-4xl font-extrabold 2xl:text-5xl">
          Message from Our Founder
        </h2>

        <p className="mt-4 text-white/90 leading-relaxed 2xl:text-2xl">
        ...
        <p className="mt-4 text-white/85 leading-relaxed 2xl:text-2xl">
        ...
        <p className="mt-6 font-semibold 2xl:text-2xl">
        ...
        <section className="relative w-full bg-[#1175a0] pb-20 px-6 overflow-hidden">
          <div className="max-w-7xl mx-auto text-center text-white relative z-10 2xl:max-w-none 2xl:px-32">
            ...
            <p className="font-semibold tracking-wide mb-2 opacity-90 2xl:text-2xl">
              → What We Do
            </p>
            ...
            <p className="text-white/80 text-lg mx-auto mt-4 2xl:text-2xl">
...
<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-16">
  {[
    ...
    >
      ...
      <h3 className="text-xl font-bold text-center 2xl:text-4xl">
        {item.name}
      </h3>

      <p className="text-white/70 text-sm mt-3 leading-relaxed text-center 2xl:text-2xl">
        {item.desc}
      </p>
    </div>
  ))}
