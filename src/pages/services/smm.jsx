  ...
  />
    ...
    <div className="bg-white text-[#0E3D55] pt-10">
      ...
      <section className="py-16 md:py-20 px-6 text-center max-w-7xl mx-auto ">
        ...
        <p className="text-[#0A3A53]/80 text-lg mt-4 max-w-4xl mx-auto xl:text-2xl">
      ...
      <section className="pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 2xl:max-w-none 2xl:px-32 ">
          ...
          <div className="flex justify-center mt-14">
            <Link
              to="/contact"
              className="px-7 py-3 text-lg rounded-full text-white hover:opacity-90 xl:text-4xl 2xl:py-6 xl:px-8"
      ...
      <section className="pt-10 md:pt-16 px-6">
        <h2 className="text-3xl 2xl:text-6xl md:text-4xl font-extrabold text-[#063349] text-center pb-6 ">
          Challenges Brands Faced Before Partnering 
          <span className="text-[#0E6388]"> With Bluenose Marketing</span>
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-6 2xl:max-w-none 2xl:px-32">
          {[
