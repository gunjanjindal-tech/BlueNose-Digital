    ...
    <div className="bg-white text-[#0E3D55] pt-10">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
                     ...
                     <h2 className="text-3xl md:text-4xl  2xl:text-6xl font-extrabold text-[#063349]">
          ...
          <p className="text-[#0A3A53]/80 text-lg mt-4 xl:text-2xl mx-auto">
      ...
      <section className="pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 2xl:max-w-none 2xl:px-32">
          ...
          <div className="flex justify-center mt-14">
            <Link
              to="/contact"
              className="px-7 py-3 text-lg rounded-full  text-white hover:opacity-90 xl:text-4xl xl:py-6 xl:px-8"
              style={{
    background: "rgb(14, 99, 136)"
  }}
            >
      ...
      <section className="pt-15 md:pt-20">
                  <h2 className="text-3xl md:text-4xl font-extrabold text-[#063349] text-center mb-14 2xl:text-6xl">
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-6 px-8 2xl:max-w-none 2xl:px-32 text-center">
  {[
    {
   ...
   {/* ===================== TESTIMONIALS ========================= */}
        ...
        <div className="max-w-7xl mx-auto px-8 text-center 2xl:max-w-none 2xl:px-32 ">
                      <h2 className="text-3xl md:text-4xl font-extrabold text-[#063349] 2xl:text-6xl">
