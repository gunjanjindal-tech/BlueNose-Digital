...
<Helmet>
 ...
 <span className="text-[#0E6388]">
          ...
          <p className="text-[#0A3A53]/80 text-lg mt-4 mx-auto xl:text-2xl">
 ...
 <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-6 px-8 2xl:max-w-none 2xl:px-32 ">
  {[
    {
