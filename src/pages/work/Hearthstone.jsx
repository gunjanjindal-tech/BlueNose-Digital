...
export default function Hearthstone() {
  ...
  <Helmet>
      ...
      {/* ================= HERO (Beaver style) ================= */}
      <section className="min-h-[80vh] w-full flex items-center bg-[#233369] text-white rounded-3xl px-4 sm:px-6 py-14 md:py-20 mb-20">
<div
  className="
    max-w-7xl mx-auto
...
>
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left mr-12">
            <div className="inline-block bg-white/20 px-4 py-2 rounded-full text-sm font-semibold mb-5 2xl:text-lg">
  ...
  <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-14">
    ...
    <div className="hidden lg:flex flex-col gap-6">
      {[
        { value: 78, suffix: "K", label: "Views" },
        { value: 32, suffix: "", label: "Videos" },
        { value: 312, suffix: "+", label: "Saves" },
        { value: 27, suffix: "%", label: "Visits" },
      ].map((item, i) => (
        <div
          key={i}
    ...
    {/* LOGO / GRID SWITCH */}
      ...
      <AnimatePresence mode="wait">
        {!showGrid ? (
          ...
          >
           <img src="/client/logo-6.png" className="h-80 sm:h-88 object-contain" />
          </motion.div>
        ) : (
          <motion.div
            key="grid"
...
<section
  ...
  className="
    ...
    2xl:px-16
  "
>            <h2 className="text-4xl font-extrabold text-[#0E6388]  2xl:text-5xl">Overview</h2>
            ...
            <div className="grid sm:grid-cols-2 gap-6 mt-10">
              {[
                ...
                >
                  ...
                  <p className="text-white/80 mt-2 text-sm 2xl:text-xl">{s.t}</p>
                </div>
              ))}
            </div>
          </section>
    ...
    2xl:h-12">
          ...
          <section id="key-strategy" className="p-10 bg-white rounded-3xl shadow border border-[#D7ECF6]">
            <h2 className="text-4xl font-extrabold text-[#0E6388]   2xl:text-5xl">Key Strategies Implemented</h2>
