...
<section
  ...
  className="
    ...
    2xl:px-16
  "
>            <h2 className="text-4xl font-extrabold text-[#0E6388] text-center sm:text-left 2xl:text-5xl">Overview</h2>
    ...
    2xl:h-12">
          ...
          <section id="challenge" className="p-6 sm:p-10 bg:white rounded-3xl border shadow border-[#D7ECF6]">
            <h2 className="text-4xl font-extrabold text-[#0E6388] text-center sm:text-left 2xl:text-5xl">Challenge</h2>
          ...
          <section id="approach" className="p-6 sm:p-10 bg:white rounded-3xl border shadow border-[#D7ECF6]">
            <h2 className="text-4xl font-extrabold text-[#0E6388] text-center sm:text-left 2xl:text-5xl">Approach</h2>
          ...
          <section id="key-strategy" className="p-6 sm:p-10 bg:white rounded-3xl border shadow border-[#D7ECF6]">
            <h2 className="text-4xl font-extrabold text-[#0E6388] text-center sm:text-left 2xl:text-5xl">Key Strategies Implemented</h2>
