...
export default function PitaNusto() {
  ...
  // Logo ↔ Grid every 3 sec (Beaver style)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    sections.forEach((id) => {
      ...
      const obs = new IntersectionObserver(
        ...
        { threshold: 0.25, rootMargin: "-120px 0px -120px 0px" }
      );
  ...
  return (
    <div className="bg-white text-[#063349] font-inter px-6 pt-[110px] pb-20">
      <Helmet>
        <title>Pita Nusto Case Study | Bluenose Digital</title>
      </Helmet>
          ...
          <div className="flex justify-center w-full max-w-[400px] h-[260px] sm:h-[330px] md:h-[480px] mx-auto">
            <AnimatePresence mode="wait">
              {!showGrid ? (
                ...
                >
                  <img src="/client/logo-3.png" className="h-80 sm:h-88 object-contain" />
                </motion.div>
              ) : (
                <motion.div
                  key="grid"
                  ...
                  transition={{ duration: 0.6 }}
                >
                  <img src="/client-grid/pita-grid.jpg" className="w-full h-full object-contain" />
                </motion.div>
              )}
            </AnimatePresence>
          </div>
          ...
          <section id="challenge" className="p-6 sm:p-10 bg-white rounded-3xl border shadow border-[#D7ECF6]">
            ...
            <div className="mt-6 p-10 rounded-3xl shadow text-white"
              ...
              <ul className="space-y-3 list-disc list-inside text-white/95">
                ...
                <li>Low-budget content requirements</li>
                <li>High-quality food visuals needed consistently</li>
              </ul>
            </div>
          </section>
