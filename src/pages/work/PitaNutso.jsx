...
export default function PitaNusto() {
  ...
  return (
      ...
      {/* ---------------- HERO SECTION ---------------- */}
<section
  className="w-full bg-[#FDF1D9] text-white rounded-3xl px-4 
...
>
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
    ...
    <div className="flex flex-col items-center text-center md:items-start md:text-left w-full md:w-1/2">
      ...
      {/* BADGE */}
      <div
        className="inline-block bg-white/20  px-4 py-2 rounded-full 
        text-sm font-semibold mb-4 shadow-sm text-black"
      >
      ...
      {/* DESCRIPTION */}
      <p className="text-xl mt-4 leading-relaxed max-w-xl text-black">
  ...
  {["Digital Planning", "Creative Flow", "Community Growth"].map((tag, i) => (
    <div
      ...
      className="
        ...
        text-black text-sm font-medium shadow
        w-[180px] text-center
        md:w-auto
      "
    >
