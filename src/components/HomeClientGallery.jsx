...
const nextClient = () => {
  ...
  return (
    <section className="pb-20 pt-6 px-6 ">
       ...
       <p className="text-[#0E6388] font-semibold tracking-wide mb-2 text-center xl:text-2xl">
      → Client Results
    </p>

      <h2 className="text-center text-4xl md:text-5xl font-extrabold text-[#063349] 2xl:text-6xl ">
        Client <span className="text-[#0E6388]">Results</span>
      </h2>


    <p className="text-[#063349]/80 text-lg xl:text-2xl text-center mx-auto mt-2 mb-8 ">
...
<div className="hidden md:flex gap-3 flex-wrap mb-6 col-span-2 justify-center">
  ...
  {clients.map((c, i) => {
    ...
    return (
      <button
        ...
        className={`
          px-4 py-1.5 text-sm rounded-full border transition 2xl:text-2xl
          ${
            i === index
              ? isLight
      ...
      <h3
  className="text-4xl font-extrabold mb-2 2xl:text-6xl"
  style={{ color: dark || forceWhiteText ? "#fff" : "#063349" }}
     ...
     <p
  className="text-lg mb-6 2xl:text-3xl"
  style={{ color: dark || forceWhiteText ? "#fff" : "#063349" }}
        >
          {data.desc}
</p>
...
>
  ...
  ">
    {item.split(" ").slice(1).join(" ")}
        ...
        <Link to={data.link}>
          <button className="px-6 py-3 rounded-full bg-white text-[#063349] font-semibold hover:bg-black hover:text-white transition 2xl:text-3xl">
            View Case →
          </button>
        </Link>
      </div>
