export default function AboutHowWeWork() {
  ...
  <div className="max-w-7xl mx-auto 2xl:max-w-none 2xl:px-32">

    {/* HEADER */}
    <div className="text-center mb-20">
      <p className="text-[#0E6388] font-semibold tracking-wide 2xl:text-2xl">→ Our Process</p>

      <h2 className="text-3xl md:text-5xl font-extrabold text-[#063349] 2xl:text-6xl">
        How We <span className="text-[#0E6388]">Work</span>
      </h2>

      <p className="text-[#063349]/70 mt-4  mx-auto text-lg leading-relaxed 2xl:text-2xl">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center mb-16 md:mb-24 ">
      ...
      <div className="relative">
        ...
        <h3 className="text-2xl sm:text-3xl 2xl:text-4xl font-extrabold text-[#0E6388] mb-3 ">
          Deep Brand Understanding
        </h3>

        <div className="w-16 sm:w-20 h-1 bg-[#0E6388] rounded-full mb-5"></div>

        <p className="text-[#063349]/80 leading-relaxed mb-6 text-sm sm:text-[17px] 2xl:text-2xl">
          We decode your brand’s voice, identity and audience to set a solid foundation for growth.
        </p>

        <ul className="space-y-3 text-[#063349]/90 text-sm sm:text-[15px] 2xl:text-xl">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center mb-16 md:mb-24">
      ...
      <div className="relative order-2 md:order-1">
        ...
        <h3 className="text-2xl sm:text-3xl font-extrabold text-[#0E6388] mb-3 2xl:text-4xl">
