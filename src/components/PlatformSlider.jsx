...
export default function PlatformShowcase() {
  ...
  return (
    <section className="py-20 xl:pt-30">
  <div className="max-w-7xl mx-auto px-6 text-center 2xl:max-w-none 2xl:px-32">
     <h2 className="text-3xl md:text-4xl font-extrabold text-[#063349 text-center 2xl:text-6xl">
    The Distinction Behind 
 <span className=" text-[#0E6388]">
     ...
     <p className="text-[#0A3A53]/80 text-lg mt-4  mx-auto xl:text-2xl ">
        From LinkedIn to TikTok insight‑driven campaigns, creative execution, and scalable systems for growth.
