...
<footer className="relative bg-white pt-16 pb-2 text-[#063349] border-t border-[#D7E6EF]">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr_1.4fr] gap-12 2xl:max-w-none 2xl:px-32">

        {/* LOGO + ABOUT */}
        <div>
          <img src="/logo/logo.jpeg" alt="Bluenose Logo" className="w-44 mb-5" />

          <p className="text-[#063349]/70 text-sm leading-relaxed max-w-sm 2xl:text-xl">
...
>
  <Linkedin className="w-5 h-5 text-[#0E6388]" />
        ...
        {/* QUICK LINKS */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-[#063349] 2xl:text-2xl">Quick Links</h3>
          <ul className="space-y-2 text-[#063349]/80 text-sm 2xl:text-xl">
        ...
        {/* CONTACT INFO */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-[#063349] 2xl:text-2xl">Contact Us</h3>

          <div className="space-y-4 text-sm text-[#063349]/85 2xl:text-xl 2xl:space-y-8">
            <a href="tel:+19027189007" className="flex gap-3 items-center hover:text-[#0E6388] transition">
              <Phone className="w-5 h-5 text-[#0E6388] 2xl:w-7 2xl:h-7" />
              +1 902-718-9007
            </a>

            <a href="mailto:sales@bluenosemarketing.com" className="flex gap-3 items-center hover:text-[#0E6388] transition 2xl:text-xl">
              <Mail className="w-5 h-5 text-[#0E6388] 2xl:w-7 2xl:h-7" />
            ...
            <a
              ...
              target="_blank"
              className="flex gap-3 items-center hover:text-[#0E6388] transition 2xl:text-xl"
            >
              <MapPin className="w-6 h-6 text-[#0E6388] 2xl:w-8 2xl:h-8" />
...
<div className="mt-10 border-t border-[#0E6388]/20 w-full ">
  <div className="pt-5 px-6 max-w-7xl mx-auto 2xl:max-w-none 2xl:px-32 ">
