...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto sm:px-6 md:px-0 py-3 flex justify-between items-center 2xl:max-w-none 2xl:px-32">

        {/* LOGO */}
        <Link to="/">
          <img
            src="/logo/logo.jpeg"
            className="w-32 md:w-36 object-contain transition-all 2xl:w-48 "
            alt="Bluenose"
          />
        </Link>

        {/* DESKTOP NAV */}
        <nav className="hidden lg:flex items-center gap-8 font-medium text-[#063349] 2xl:text-2xl">
...
>
  ...
  <div
    className={`
      absolute left-0 mt-3 bg-white shadow-xl rounded-xl w-64 p-3 2xl:w-80 2xl:pt-4
